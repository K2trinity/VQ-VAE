...
class tif_dataset(data.Dataset):
    def __init__(self, data_path, data_norm_type='min_max', augment=True, aniso_dim=-2, load_size=None):
...
if __name__ == '__main__':
    ...
    data_path = '/home/ryuuyou/E5/project/data/RESIN_datasets/neuron/64_1k'
